    ...
    public function indexAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($this->form->isValid()) {
                ...
                // trigger event
                $this->getEventManager()->trigger('productTypeCreate', $this, array(
                ...
                // return
                return $this->redirect()->toRoute('product-type-view', array('productTypeId' => $productTypeEntity->getProductTypeId()));
            }
        }
