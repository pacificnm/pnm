...
class ConfigMapper implements ConfigMapperInterface
{
     ...
     * @param ConfigEntity $prototype            
     */
    public function __construct(AdapterInterface $readAdapter, AdapterInterface $writeAdapter, HydratorInterface $hydrator, ConfigEntity $prototype)
    {
     ...
     * {@inheritDoc}
     *
     * @see \Config\Mapper\ConfigMapperInterface::getAll()
     */
    public function getAll($filter)
    {
        $sql = new Sql($this->readAdapter);
        
        $select = $sql->select('config');
     ...
     * {@inheritDoc}
     *
     * @see \Config\Mapper\ConfigMapperInterface::get()
     */
